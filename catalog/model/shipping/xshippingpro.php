...
class ModelShippingXshippingpro extends Model {
    ...
    public function __construct($registry) {
        ...
        $this->mtype = 'shipping';
        $this->ext_path = 'shipping/xshippingpro';
    }
   ...
   private function iterateEquation($equation, $type, $rates, $method_specific_data, $_cart_data, $quote_data, $percent_of, $cost = 0, $modifier_amount = 0) {
    ...
    private function getJS($xshippingpro_estimator) {
        ...
        $url = array(
            'country' => VERSION >=  '2.1.0.1' ? 'index.php?route=total/shipping/country' : 'index.php?route=checkout/shipping/country',
            'estimate' => 'index.php?route=shipping/xshippingpro/estimate_shipping'
        );
