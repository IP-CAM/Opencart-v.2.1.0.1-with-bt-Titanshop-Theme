		...
		<section class="product-thumb bt-item transition">		
			...
			<div class="small_detail">
				...
				<div class="button-group">
					...
					<a class="btn-wishlist" onclick="btadd.wishlist('<?php echo $mainproduct['product_id']; ?>');"><?php echo $button_wishlist; ?></a>
					<a class="btn-compare" onclick="btadd.compare('<?php echo $mainproduct['product_id']; ?>');"><?php echo $button_compare; ?></a>
				</div>	
			</div>	
		</section>
		</div>
