	...
	<?php $mainproduct = $product_data['mainproduct'];?>
		...
		<section class="bt-item-large product-thumb">		
			...
			<div class="button-group">
				<button class="btn-cart" type="button" onclick="btadd.cart('<?php echo $mainproduct['product_id']; ?>');"><?php echo $button_cart; ?></button>
		...
		<div id="boss_featured_<?php echo $module; ?>">
			...
			<section class="product-thumb bt-item transition">
				...
				<div class="small_detail">
					...
					<div class="button-group">
						<button class="btn-cart" type="button" onclick="btadd.cart('<?php echo $product['product_id']; ?>');"><?php echo $button_cart; ?></button>
