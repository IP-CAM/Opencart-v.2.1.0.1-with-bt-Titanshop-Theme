...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_module_account_picture->addCustomerPhoto($customer_id,$image,$image_tmp);
		...
		$data['text_none'] = $this->language->get('text_none');
			...
			$data['entry_account_picture'] = $this->language->get('entry_account_picture');
			$data['text_account_picture'] = $this->language->get('text_account_picture');		
			$data['button_account_picture'] = $this->language->get('button_account_picture');
	...
	private function validate() {
		...
		if ((utf8_strlen(trim($this->request->post['lastname'])) < 1) || (utf8_strlen(trim($this->request->post['lastname'])) > 32)) {
			...
			if (!empty($this->request->files['account_picture']['name'])) {
