    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
			 ...
			 <legend><?php echo $text_account_picture; ?></legend>
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $entry_account_picture; ?></label>
            <div class="col-sm-10">
              ...
              <div class="text-danger"><?php echo $error_extension; ?></div>
              <?php } ?>
              <?php if ($error_size) { ?>
