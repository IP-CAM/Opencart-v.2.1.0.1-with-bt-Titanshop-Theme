						...
						<?php foreach($menus as $menu){ ?>
						 <tr id="menu-row<?php echo $menu['key']; ?>">
							<td class="left"><?php foreach ($languages as $language) { ?>
								<input name="boss_menucategory_config[<?php echo $menu['key']; ?>][title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($menu['title'][$language['language_id']]) ? $menu['title'][$language['language_id']] : ''; ?>" />
								<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />
							<?php } ?></td>
							...
							<input type="hidden" name="boss_menucategory_config[<?php echo $menu['key']; ?>][icon]" value="<?php echo $menu['icon']; ?>" id="input-image<?php echo $menu['key']; ?>" /></td>
							
							<td class="left"><select style="width:140px;" name="boss_menucategory_config[<?php echo $menu['key']; ?>][category_id]">
							...
							<td class="right"><input type="text" name="boss_menucategory_config[<?php echo $menu['key']; ?>][column]" value="<?php echo $menu['column']; ?>" size="3" /></td>
							<td class="right"><input type="text" name="boss_menucategory_config[<?php echo $menu['key']; ?>][sub_width]" value="<?php echo $menu['sub_width']; ?>" size="3" /></td>
							...
							<input type="hidden" name="boss_menucategory_config[<?php echo $menu['key']; ?>][bgimage]" value="<?php echo $menu['bgimage']; ?>" id="input-bgimage<?php echo $menu['key']; ?>" /></td>
							  
							<td class="left"><select name="boss_menucategory_config[<?php echo $menu['key']; ?>][status]">
							  <?php if ($menu['status']) { ?>
							  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
							  <option value="0"><?php echo $text_disabled; ?></option>
							  <?php } else { ?>
							...
							<td class="right"><input type="text" name="boss_menucategory_config[<?php echo $menu['key']; ?>][sort_order]" value="<?php echo $menu['sort_order']; ?>" size="3" /></td>
...
function addMenu() {
	...
	html += '    <td class="left">';
	<?php foreach ($languages as $language) { ?>
	html += '      <input name="boss_menucategory_config[' + token + '][title][<?php echo $language['language_id']; ?>]" value="Menu Title" />';
	...
	html += '    <td class="left"><select style="width:140px;" name="boss_menucategory_config[' + token + '][category_id]">';
	<?php foreach ($categories as $category) { ?>
    html += '      <option value="<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></option>';
	 <?php } ?>
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="boss_menucategory_config[' + token + '][column]" value="1" size="3" /></td>';
	html += '    <td class="right"><input type="text" name="boss_menucategory_config[' + token + '][sub_width]" value="240" size="3" /></td>';
	
	html += '  <td class="text-left"><a href="" id="thumb-bgimage' + token + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="boss_menucategory_config['+ token +'][bgimage]" value="" id="input-bgimage' + token + '" /></td>';
	
	html += '    <td class="left"><select name="boss_menucategory_config[' + token + '][status]">';
    html += '      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
    html += '      <option value="0"><?php echo $text_disabled; ?></option>';
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="boss_menucategory_config[' + token + '][sort_order]" value="0" size="3" /></td>';
