...
var ajaxaction = 'index.php?route=module/webservice/saveComponent&token='+token;
var save_element_ajaxaction = 'index.php?route=module/webservice/saveElement&token='+token;
var save_heading_ajaxaction = 'index.php?route=module/webservice/saveHeading&token='+token;
var get_component_ajaxaction = 'index.php?route=module/webservice/getComponent&token='+token;
var get_componenttype_ajaxaction = 'index.php?route=module/webservice/getComponentType&token='+token;
var delete_ajaxaction = 'index.php?route=module/webservice/deleteComponent&token='+token;
var deleteImage_ajaxaction = 'index.php?route=module/webservice/deleteImage&token='+token;
...
function getCustomProduct(product_id) {
    ...
    html = '';
    $.ajax({
        url: 'index.php?route=module/webservice/selectProduct&token='+token,
        dataType: 'json',
